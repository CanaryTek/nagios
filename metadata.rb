...
recipe 'nagios::nrpe_proxy', 'Installs and configures a nrpe proxy for internal hosts'
recipe 'nagios::nsca_server', 'Installs and configures nsca server for nsca alert reception'
